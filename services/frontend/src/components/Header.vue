          ...
          <div class="hidden lg:ml-4 lg:block">
            <div class="flex items-center">
              ...
              <div v-if="isAuthenticated" class="flex items-center space-x-3">
                ...
                <!-- Profile dropdown -->
                <div x-data="Components.menu({ open: false })" x-init="init()"  class="relative ml-3 flex-shrink-0">
                  <div>
                    <button type="button" class="flex rounded-full bg-gray-50 text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-50" id="user-menu-button" x-ref="profileButton1" @click="onButtonClick()" @keyup.space.prevent="onButtonEnter()" @keydown.enter.prevent="onButtonEnter()" aria-expanded="false" aria-haspopup="true" x-bind:aria-expanded="open.toString()">
        ...
        <div class="border-t border-gray-200 pt-4 pb-3">
          <div class="flex items-center px-5">
            <div v-if="isAuthenticated" class="flex items-center space-x-3">
              ...
              <button @click="onLogout" type="button" class="ml-auto flex-shrink-0 rounded-full bg-gray-50 p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-50">
