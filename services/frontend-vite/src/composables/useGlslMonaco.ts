...
export function useGlslMonaco() {
  var langId = "glsl";

  editor.defineTheme("glsl-vs", {
    base: "vs",        // Наследуем светлую тему
    inherit: true,     // Используем встроенные цвета редактора
    rules: [
      { token: "comment.line",                foreground: "6a737d" },
      { token: "comment.block",               foreground: "6a737d" },

      { token: "keyword.control.preprocessor", foreground: "d73a49", fontStyle: "bold" },
      { token: "meta.preprocessor",            foreground: "800080", fontStyle: "italic" },

      { token: "operator",                     foreground: "d73a49" },
      { token: "invalid",                      foreground: "000020", background: "FF0000" },

      { token: "constant",                     foreground: "b31d28" },

      { token: "entity.name.function",         foreground: "795E26" },
      { token: "entity.name.type",             foreground: "267f99" },
      { token: "storage.type",                 foreground: "c270ba", fontStyle: "bold italic" },
      { token: "keyword",                      foreground: "005cc5" },
      { token: "keyword.editor_extras",        foreground: "ffffff" },
      { token: "variable.name",                foreground: "505050" },
  ...
  languages.setMonarchTokensProvider(langId, {
    ...
    tokenizer: {
      root: [
        ...
        [/[\@][a-z_\-]*/, {
          cases: {
            "@editor_extras": "keyword.control.preprocessor"
          }
        }],
